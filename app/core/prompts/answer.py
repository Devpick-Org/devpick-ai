...
### confidence
- 0.9 이상: 참고 문서가 직접 관련되고 답변이 정확
- 0.7~0.9: 일반 지식 기반이지만 답변에 자신 있음
- 0.7 미만: 참고 문서 부족 또는 질문이 모호하여 답변 품질이 낮을 수 있음
"""
...
ANSWER_TOOL = {
    ...
    "input_schema": {
        ...
        "properties": {
            ...
            "confidence": {
                "type": "number",
                "description": "답변 품질 자체 평가 0.0~1.0",
            },
        },
        "required": [
            "answer_content",
